...
const char D_INTRO_0[] PROGMEM = "RF Hunter";
const char D_INTRO_1[] PROGMEM = "by @rdhrobotics";
...
class DisplayUI {
    public:
        ...
        ADCButton* upBtn    = NULL;
        ADCButton* downBtn  = NULL;
        ADCButton* leftBtn  = NULL;
        ADCButton* rightBtn = NULL;
        ADCButton* enterBtn = NULL;
        ADCButton* backBtn  = NULL;
        ...
        void on();
        void off();
        bool backHolding(uint32_t time);
